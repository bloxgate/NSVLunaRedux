			...
			if(M == user)
				...
				if(prob(power*2))
					...
					for(var/mob/O in (viewers(M) - user - M))
						O.show_message("\red <b>[user] tried to stab [M] in the chest with [src], but missed!</b>", 1)
					M << "\red <b>[user] tried to stab you in the chest with [src], but missed!</b>"
					user << "\red <b>You tried to stab [M] in the chest with [src], but missed!</b>"
					*/
