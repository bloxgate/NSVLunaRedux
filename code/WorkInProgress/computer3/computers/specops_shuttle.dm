...
/obj/machinery/computer3/specops_shuttle/attack_hand(var/mob/user as mob)
	...
	if (temp)
		...
		dat += {"
		<b>Location:</b> [specops_shuttle_moving_to_station || specops_shuttle_moving_to_centcom ? "Departing for [vessel_name] in ([specops_shuttle_timeleft] seconds.)":specops_shuttle_at_station ? "Station":"Dock"]<BR>
